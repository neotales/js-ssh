...
export declare function parseSftpVersion(input: Uint8Array, maximumPacketLength?: number): (SFTPVersion & {
    consumed: number;
}) | undefined;
...
export declare function parseSftpHandle(input: Uint8Array, maximumPacketLength?: number): (SFTPHandle & {
    consumed: number;
}) | undefined;
/** Formats SSH_FXP_DATA. */
export declare function formatSftpData(response: SFTPData): Uint8Array;
/** Parses SSH_FXP_DATA. */
export declare function parseSftpData(input: Uint8Array, maximumPacketLength?: number): (SFTPData & {
    consumed: number;
}) | undefined;
/** Formats SSH_FXP_STATUS. */
export declare function formatSftpStatus(response: SFTPStatus): Uint8Array;
/** Parses SSH_FXP_STATUS. */
export declare function parseSftpStatus(input: Uint8Array, maximumPacketLength?: number): (SFTPStatus & {
    consumed: number;
}) | undefined;
...
/** Parses SSH_FXP_NAME. */
export declare function parseSftpName(input: Uint8Array, maximumPacketLength?: number): (SFTPName & {
    consumed: number;
}) | undefined;
...
export declare function parseSftpAttributes(input: Uint8Array, maximumPacketLength?: number): ({
    id: number;
    attributes: SFTPAttributes;
    consumed: number;
}) | undefined;
