...
export function parseSftpVersion(input, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
...
export function parseSftpHandle(input, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
...
/** Parses SSH_FXP_DATA. */
export function parseSftpData(input, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
...
export function parseSftpStatus(input, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
...
/** Parses SSH_FXP_NAME. */
export function parseSftpName(input, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
...
export function parseSftpAttributes(input, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
...
function expectPacket(input, type, name, maximumPacketLength = DEFAULT_MAXIMUM_PACKET_LENGTH) {
    const packet = readSftpPacket(input, maximumPacketLength);
    if (!packet)
        return undefined;
    if (packet.type !== type)
