...
import { formatIdentification, parseIdentification, readIdentification, SSHIdentificationError, } from "../identification.js";
...
test("SSH identification parsing enforces version, ASCII, framing, and line limits", () => {
    ...
    throws(() => formatIdentification({ protocolVersion: "2.0", softwareVersion: "test", comments: "" }), SSHIdentificationError);
